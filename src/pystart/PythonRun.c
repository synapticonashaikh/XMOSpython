...
char * FnRunTheCommand(char *commad, uint8_t type)
{
    ...
    byte ByteCode [] = 
    {};

    //run user .mpy file without erasing it
    mp_reader_t reader;
    mp_reader_new_mem(&reader, ByteCode, sizeof(ByteCode), 0);
    // printf("mp_reader_new_mem\n");
    // mp_module_context_t *context = m_new_obj(mp_module_context_t);
    // printf("m_new_obj\n");
    // context->module.globals = mp_globals_get();
    // printf("mp_globals_get\n");
    // mp_compiled_module_t compiled_module = mp_raw_code_load(&reader, context);
    // printf("mp_raw_code_load\n");
