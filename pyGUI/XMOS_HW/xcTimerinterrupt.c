...
*/  
    ...
    extern void FnTimerInterruptStart(uint64_t Var, uint32_t TimeInMsec); 
    extern void FnTimerInterruptInit (uint64_t Var);    
    extern void FnTimerInterruptStop (uint64_t Var);    
 ...
 * Details	    : main function, start of the code
 * *********************************************************************/
unsigned FnTimerInterruptGetTime(uint64_t Var)
{ return RESET; }                                                           
